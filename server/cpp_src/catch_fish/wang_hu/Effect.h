...
public:
	...
	virtual long long  Execute(MyObject* pSelf, MyObject* pTarget, std::list<MyObject*>& list, bool bPretreating) = 0;
...
public:
	CEffectAddMoney();
	virtual long long  Execute(MyObject* pSelf, MyObject* pTarget, std::list<MyObject*>& list, bool bPretreating);
	long long  lSco;
};
